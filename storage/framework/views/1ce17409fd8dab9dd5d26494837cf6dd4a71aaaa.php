...
<?php $__env->startSection('content'); ?>
  ...
  <div id="events-container" class="col-md-12">
    <?php if($search): ?>
      <h2>Você está procurando por: <?php echo e($search); ?>:</h2>       
    <?php else: ?>
    ...
    <div id="cards-container" class="row">
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php if(count($events) === 0 && $search): ?>
            <p>Não foi possível encontrar nenhum evento com o termo: <?php echo e($search); ?>! <a href="/">Ver todos</a>  </p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\hdcevents\CrudLaravelPHP\resources\views/welcome.blade.php ENDPATH**/ ?>