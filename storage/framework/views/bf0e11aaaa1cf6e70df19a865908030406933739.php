...
<?php $__env->startSection('title', 'Editando Evento'); ?>

<?php $__env->startSection('content'); ?>

    <div id="event-create-container" class="col-md-6 offset-md-3">
        <h1>Editando o evento: <?php echo e($event->title); ?></h1>
        <form action="/events/update/<?php echo e($event->id); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="city" class="form-control" id="city" name="city" value="<?php echo e($event->city); ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" placeholder="O que acontecerá no evento?"><?php echo e($event->description); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\hdcevents\CrudLaravelPHP\resources\views/events/edit.blade.php ENDPATH**/ ?>