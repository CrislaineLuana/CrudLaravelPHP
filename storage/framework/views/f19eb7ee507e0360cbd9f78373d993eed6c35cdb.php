                    ...
                    <tr>
                        ...
                        <td>
                            <form action="/events/leave/<?php echo e($event->id); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field("DELETE"); ?>
                                <button  type="submit" class="btn btn-danger edit-btn"> <ion-icon name="trash-outline" ></ion-icon> Sair do Evento</button> 
                            </form>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\hdcevents\CrudLaravelPHP\resources\views/events/dashboard.blade.php ENDPATH**/ ?>